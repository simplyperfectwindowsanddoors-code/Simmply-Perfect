...
const partnerTerms = [
  "Partnership opportunities are subject to verification and formal approval by Simmply Perfect Group.",
  "Submission of this application form does not automatically establish a commercial partnership or binding agency.",
  "Project quotes, dealer discounts, commercial terms, and credit facilities are negotiated and finalized separately.",
  "Partners agree to maintain the confidentiality of pricing tiers, architectural drawings, and proprietary business specifications.",
  "Simmply Perfect Group reserves the right to amend partnership standards and catalog technical specs in accordance with industry benchmarks.",
];
          ...
          <section className="flex flex-col justify-between border-b border-slate-200/80 bg-slate-50/75 p-6 sm:p-8 lg:col-span-5 lg:h-full lg:overflow-y-auto lg:border-b-0 lg:border-r lg:p-8 xl:p-10">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-[#0A2E6F]/15 bg-[#0A2E6F]/[0.06] px-4 py-1.5 text-xs font-bold uppercase tracking-[0.2em] text-[#0A2E6F]">
                ...
                <span>B2B Partner Ecosystem</span>
              </div>

              <h1 className="mt-3.5 text-2xl font-extrabold tracking-tight text-slate-900 sm:text-3xl xl:text-4xl leading-tight">
                Partner With <span className="text-[#0A2E6F]">Simmply Perfect</span>
              </h1>

              <p className="mt-2.5 text-sm leading-relaxed text-slate-600">
                Collaborate on premium residential & commercial developments. Expand your product offering with our architectural UPVC windows, precision doors, luxury interiors, and custom metal works.
              </p>

              {/* AUDIENCE PILLS */}
              <div className="mt-4 flex flex-wrap items-center gap-1.5">
                {["Architects", "Interior Designers", "Builders & Developers", "Contractors"].map((tag) => (
                  <span
                    key={tag}
              ...
              <div className="mt-6 space-y-3">
                <Benefit
                  icon={BadgePercent}
                  title="Direct Trade Pricing & High Margins"
                  description="Access premium trade pricing, structured discounts, and high-margin estimates."
                />

                <Benefit
                  icon={Wrench}
                  title="End-to-End Installation Execution"
                  description="Certified site technicians handle surveys, custom sizing, and structural installation."
                />

                <Benefit
                  icon={Layers}
                  title="European Certified Profile Standards"
                  description="German-engineered UPVC, thermal-break aluminium, and solid timber options."
                />

                <Benefit
                  icon={Headphones}
                  title="Sample Kits & Dedicated Account Manager"
                  description="Receive corner sections, finish samples, catalogs, and direct project assistance."
                />
              </div>
            </div>
            ...
            <div className="mt-6 rounded-xl border border-slate-200 bg-white p-3.5 shadow-2xs">
              <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-[#0A2E6F]">
                <ShieldCheck className="h-4 w-4" /> Commercial Assurance
              </div>
              <p className="mt-0.5 text-xs text-slate-500">
                All partnership applications are reviewed by our regional engineering and business development team within 24 to 48 hours.
              </p>
            </div>
          </section>
            ...
            <div className="mx-auto w-full max-w-2xl">
              <div className="mb-5 border-b border-slate-200 pb-3.5">
                ...
                <p className="mt-0.5 text-xs text-slate-500 sm:text-sm">
                  Please fill in your company and contact credentials below to get onboarded.
                </p>
              </div>
              ...
              {submitStatus === "success" ? (
                <div className="flex flex-col items-center justify-center py-16 text-center">
                  ...
                  <p className="mx-auto mt-2 max-w-md text-sm leading-relaxed text-slate-600">
                    Thank you for applying to partner with Simmply Perfect Group. Our business development team will review your credentials and get back to you shortly.
                  </p>
                  <Link
                    href="/"
                ...
                >
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    >
                      <input
                        ...
                        placeholder="Studio / Builder / Firm"
                        className="partner-input"
                      />
                    </Field>
                  </div>
                  ...
                  <div>
                    <label className="mb-1.5 block text-xs font-bold uppercase tracking-wider text-slate-700">
                      Scope of Partnership / Project Requirements <span className="text-[#0A2E6F]">*</span>
                    </label>
                    ...
                    >
                      ...
                      <textarea
                        ...
                        rows={3}
                        placeholder="Tell us about your ongoing projects, expected volume, or services needed..."
                  ...
                  <div className="rounded-xl border border-slate-200 bg-slate-50/50 p-3.5">
                    <label className="flex cursor-pointer items-start gap-3">
                      ...
                      <span className="text-xs leading-relaxed text-slate-600">
                        ...
                        and confirm that all submitted business details are accurate.
                      </span>
                    </label>
                  </div>
                  ...
                  <button
                    ...
                    className="group flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-[#0A2E6F] px-6 text-xs font-bold uppercase tracking-wider text-white shadow-[0_10px_25px_rgba(10,46,111,0.2)] transition-all duration-200 hover:bg-[#0c3784] hover:shadow-[0_15px_30px_rgba(10,46,111,0.3)] disabled:cursor-not-allowed disabled:opacity-60"
                  >
                    {isSubmitting ? (
                      <>
            ...
            >
              <div className="flex items-center justify-between border-b border-slate-100 px-6 py-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-slate-900">Partnership Terms & Conditions</h3>
                    <p className="text-xs text-slate-500">Simmply Perfect Group B2B Guidelines</p>
                  </div>
                </div>
                <button
                  type="button"
